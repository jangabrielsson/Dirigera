...
- ✨ **Feature**: add release v0.1.3 forum post HTML
- 🐛 **Fix**: correct formatting of file declarations in Dirigera.lua
...
- ✨ **Feature**: chore: update version to 0.1.1 and enhance changelog for new features
